...
define("_FROM","Od");
define("_DATE","Dátum");
define("_DONTHAVEMESSAGES","Nemáte žiadne odkazy");
...
define("_ALLREGCANPOST","Všetci registrovaní užívatelia môžu posiela súkromné odkazy");
define("_TO","pre");
...
define("_CHECKNAMEANDTRY","Prosím, zadajte nové uživate¾ské meno a skúste znova.");
define("_MSGPOSTED","Váš odkaz bol odoslaný.");
define("_RETURNTOPMSG","Kliknutím sem možete obnovi súkromné odkazy.");
define("_MSGDELETED","Vaše odkazy boli zmazané.");
define("_BBGO","ïalej");
define("_BBNEWPMSG","Nové správy");
define("_BBNONEWPMSG","Žiadne nové správy");
define("_BBTOTALPMSG","Správ spolu");
define("_BBEMPTYPMSG","Nemáte žiadnu správu");
...
define("_BBNOFORUM","Žiadne ïalšie fórum");
define("_BBBANNED","Zakázaný");
define("_CLICKSMILEBUTTONS","Kliknutím na smajlík ho vložíte do správy");
define("_CLICKCODEBUTTONS","Kliknutím na nasledovné tlaèítka vložíte BBCode do správy:");
define("_PRIVMSGERROR","Chyba súkromných správ");
define("_USERDOESNTEXIST","Vybraný užívate¾ neexistuje v našej databáze");
